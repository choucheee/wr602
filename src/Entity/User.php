...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: UserContact::class, orphanRemoval: true)]
    private Collection $userContacts;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Generation::class, orphanRemoval: true)]
